...
function runBaseTests() {
  px_app_helpers_1 = document.getElementById('px_app_helpers_1');

  suite('Base Automation Tests for px-app-helpers', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-app-helpers fixture is created', function() {
      assert.isTrue(document.getElementById('px_app_helpers_1') !== null);
    });
